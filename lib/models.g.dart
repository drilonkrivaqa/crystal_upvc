...
class ShtesaOptionAdapter extends TypeAdapter<ShtesaOption> {
  ...
  ShtesaOption read(BinaryReader reader) {
    ...
    return ShtesaOption(
      ...
      pricePerMeter: fields[2] as double,
    );
  }
...
class ProfileShtesaAdapter extends TypeAdapter<ProfileShtesa> {
  @override
  final int typeId = 11;

  @override
  ProfileShtesa read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ProfileShtesa(
      profileSetIndex: fields[0] as int,
      options:
          fields[1] == null ? [] : (fields[1] as List).cast<ShtesaOption>(),
    );
  }

  @override
  void write(BinaryWriter writer, ProfileShtesa obj) {
    writer
      ..writeByte(2)
      ..writeByte(0)
...
class WindowDoorItemAdapter extends TypeAdapter<WindowDoorItem> {
  ...
  WindowDoorItem read(BinaryReader reader) {
    ...
    return WindowDoorItem(
      ...
      perRowVerticalAdapters: (fields[29] as List?)
          ?.map<List<bool>>((dynamic row) => (row as List).cast<bool>())
          .toList(),
      shtesaTop: fields[30] == null ? false : fields[30] as bool,
      shtesaBottom: fields[31] == null ? false : fields[31] as bool,
      shtesaLeft: fields[32] == null ? false : fields[32] as bool,
      shtesaRight: fields[33] == null ? false : fields[33] as bool,
      shtesaOptionIndex: fields[34] as int?,
      shtesaProfileSetIndex: fields[35] as int?,
      shtesaSizeMm: fields[36] as int?,
      shtesaPricePerMeter: fields[37] as double?,
    );
  }
  ...
  void write(BinaryWriter writer, WindowDoorItem obj) {
    writer
      ...
      ..writeByte(34)
      ..write(obj.shtesaOptionIndex)
      ..writeByte(35)
      ..write(obj.shtesaProfileSetIndex)
      ..writeByte(36)
      ..write(obj.shtesaSizeMm)
      ..writeByte(37)
      ..write(obj.shtesaPricePerMeter);
  }
