...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get productionPipesPerCut => 'Pipes per cut';
  ...
  String productionHekriGroupCount(int count, Object pipesPerGroup) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: '$count group of $pipesPerGroup pipes',
      other: '$count groups of $pipesPerGroup pipes',
    );
  }
  ...
  String productionHekriPartialCoupleTitle(
    ...
    return 'Couple $index ($pipesCount of $pipesPerGroup pipes)';
  }
  ...
  String productionHekriPartialGroupTitle(
      Object index, Object pipesCount, Object pipesPerGroup) {
    return 'Group $index ($pipesCount of $pipesPerGroup pipes)';
  }

  @override
  String productionHekriCutPlan(Object segments) {
    return 'Cut into $segments.';
  }
  ...
  String productionHekriCutSegment(int count, Object length) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: '$count cut at ${length}mm',
      other: '$count cuts at ${length}mm',
    );
  }
