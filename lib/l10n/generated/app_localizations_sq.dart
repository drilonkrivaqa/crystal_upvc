...
class AppLocalizationsSq extends AppLocalizations {
  ...
  @override
  String get productionPipesPerCut => 'Tuba për prerje';
  ...
  String productionHekriGroupCount(int count, Object pipesPerGroup) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: '$count grup me $pipesPerGroup tuba',
      other: '$count grupe me $pipesPerGroup tuba',
    );
  }
  ...
  String productionHekriPartialCoupleTitle(
    ...
    return 'Çift $index ($pipesCount nga $pipesPerGroup tuba)';
  }
  ...
  String productionHekriPartialGroupTitle(
      Object index, Object pipesCount, Object pipesPerGroup) {
    return 'Grup $index ($pipesCount nga $pipesPerGroup tuba)';
  }

  @override
  String productionHekriCutPlan(Object segments) {
    return 'Prij në $segments.';
  }
  ...
  String productionHekriCutSegment(int count, Object length) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: '$count prerje në ${length}mm',
      other: '$count prerje në ${length}mm',
    );
  }
