...
abstract class AppLocalizations {
  ...
  /// No description provided for @productionPipesPerCut.
  ///
  /// In en, this message translates to:
  /// **'Pipes per cut'**
  String get productionPipesPerCut;

  /// No description provided for @productionHekriPipeCount.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0 {0 pipes} one {{count} pipe} other {{count} pipes}}'**
  String productionHekriPipeCount(int count);

  /// No description provided for @productionHekriCoupleCount.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one {{count} couple} other {{count} couples}}'**
  String productionHekriCoupleCount(int count);

  /// No description provided for @productionHekriGroupCount.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one {{count} group of {pipesPerGroup} pipes} other {{count} groups of {pipesPerGroup} pipes}}'**
  String productionHekriGroupCount(int count, Object pipesPerGroup);

  /// No description provided for @productionHekriPipeTitle.
  ///
  /// In en, this message translates to:
  /// **'Pipe {index}'**
  String productionHekriPipeTitle(Object index);

  /// No description provided for @productionHekriCoupleTitle.
  ///
  /// In en, this message translates to:
  /// **'Couple {index}'**
  String productionHekriCoupleTitle(Object index);

  /// No description provided for @productionHekriPartialCoupleTitle.
  ///
  /// In en, this message translates to:
  /// **'Couple {index} ({pipesCount} of {pipesPerGroup} pipes)'**
  String productionHekriPartialCoupleTitle(
      Object index, Object pipesCount, Object pipesPerGroup);

  /// No description provided for @productionHekriGroupTitle.
  ///
  /// In en, this message translates to:
  /// **'Group {index}'**
  String productionHekriGroupTitle(Object index);

  /// No description provided for @productionHekriPartialGroupTitle.
  ///
  /// In en, this message translates to:
  /// **'Group {index} ({pipesCount} of {pipesPerGroup} pipes)'**
  String productionHekriPartialGroupTitle(
      Object index, Object pipesCount, Object pipesPerGroup);

  /// No description provided for @productionHekriCutPlan.
  ///
  /// In en, this message translates to:
  /// **'Cut into {segments}.'**
  String productionHekriCutPlan(Object segments);

  /// No description provided for @productionHekriCutSegment.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one {{count} cut at {length}mm} other {{count} cuts at {length}mm}}'**
