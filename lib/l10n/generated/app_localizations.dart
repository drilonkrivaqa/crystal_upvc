...
abstract class AppLocalizations {
  ...
  /// No description provided for @shtesaTitle.
  ///
  /// In en, this message translates to:
  /// **'Shtesa (Additions)'**
  String get shtesaTitle;

  /// No description provided for @shtesaProfile.
  ///
  /// In en, this message translates to:
  /// **'Shtesa for {profile}'**
  String shtesaProfile(String profile);

  /// No description provided for @shtesaAdd.
  ///
  /// In en, this message translates to:
  /// **'Add shtesa'**
  String get shtesaAdd;

  /// No description provided for @shtesaEmpty.
  ///
  /// In en, this message translates to:
  /// **'No shtesa options yet.'**
  String get shtesaEmpty;

  /// No description provided for @shtesaSize.
  ///
  /// In en, this message translates to:
  /// **'Shtesa size (mm)'**
  String get shtesaSize;

  /// No description provided for @shtesaPrice.
  ///
  /// In en, this message translates to:
  /// **'Price per meter'**
  String get shtesaPrice;
  ...
  /// No description provided for @shtesaSides.
  ///
  /// In en, this message translates to:
  /// **'Shtesa per side'**
  String get shtesaSides;

  /// No description provided for @shtesaEffective.
  ///
  /// In en, this message translates to:
  /// **'Effective size with shtesa: {width} x {height} mm'**
