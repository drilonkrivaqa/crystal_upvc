...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get productionPipesPerCut => 'Tubi per taglio';
  ...
  String productionHekriGroupCount(int count, Object pipesPerGroup) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: '$count gruppo di $pipesPerGroup tubi',
      other: '$count gruppi di $pipesPerGroup tubi',
    );
  }
  ...
  String productionHekriPartialCoupleTitle(
    ...
    return 'Coppia $index ($pipesCount di $pipesPerGroup tubi)';
  }
  ...
  String productionHekriPartialGroupTitle(
      Object index, Object pipesCount, Object pipesPerGroup) {
    return 'Gruppo $index ($pipesCount di $pipesPerGroup tubi)';
  }

  @override
  String productionHekriCutPlan(Object segments) {
    return 'Taglia in $segments.';
  }
  ...
  String productionHekriCutSegment(int count, Object length) {
    return intl.Intl.pluralLogic(
      count,
      locale: localeName,
      one: '$count taglio a ${length}mm',
      other: '$count tagli a ${length}mm',
    );
  }
